...
If you have downloaded the application from github, you will additionally need to download the SNPD (1).db from this onedrive, found at the path 'Application/SNPB (1).db'.
